...
import xyz.brassgoggledcoders.moarboats.renderers.tesserellator.TessellatorBakedQuad;
...
public class ItemRenderer<I extends Item> implements IModelCustomData {
	...
	public static class ItemOverride<I extends Item> extends ItemOverrideList {
		...
		@Override
		@Nonnull
		public BakedItemModel<I> handleItemState(@Nonnull IBakedModel originalModel,@Nonnull ItemStack stack,
